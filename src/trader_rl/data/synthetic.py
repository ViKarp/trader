"""Helpers for generating reproducible synthetic market data."""
...
def make_or_load_sample_csv(path: str, n_symbols: int = 4, bars: int = 6000, seed: int = 0) -> pd.DataFrame:
    """Generate or load a simple synthetic OHLCV dataset."""
